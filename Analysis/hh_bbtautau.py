...
def GetWeight(channel, cat, boosted_categories):
    weights_to_apply = ["weight_MC_Lumi_pu"]#["weight_MC_Lumi_pu", "weight_L1PreFiring_Central"]#,"weight_L1PreFiring_ECAL_Central", "weight_L1PreFiring_Muon_Central"]
    trg_weights_dict = {
...
class DataFrameBuilderForHistograms(DataFrameBuilderBase):
    ...
    def deepTauYear(self):
        return self.config['deepTauYears']["v"+self.deepTauVersion]
